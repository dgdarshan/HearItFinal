...
public abstract class MainServiceActivity extends PermissionsActivity {
    public static final String TAG = MainServiceActivity.class.getSimpleName();
    ...
    public void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        serviceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ...
                MainServiceActivity.this.onServiceConnected();
